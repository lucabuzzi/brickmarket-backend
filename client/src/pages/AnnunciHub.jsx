...
export default function AnnunciHub() {
  ...
  return (
    <div className="page annunci-hub max-w-[1400px] mx-auto px-4 py-12 animate-fadeIn">
      {/* HERO */}
      <section className="relative mb-16 py-20 px-8 bg-[#050402] rounded-[48px] border border-white/5 shadow-2xl overflow-hidden text-center">
        ...
        <div className="relative z-10 max-w-3xl mx-auto">
          ...
          >
            <Tag size={14} /> {t('hubs.annunci.eyebrow')}
          </motion.div>
          ...
          >
            {t('hubs.annunci.cta')} <ChevronDown size={16} className="animate-bounce text-gold-400" />
          </motion.div>
        </div>
      </section>
